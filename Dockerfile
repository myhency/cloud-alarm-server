#docker build -t cloud-alarm-server-renewal:v0.0.4-rc4 .
#docker tag cloud-alarm-server-renewal:v0.0.4-rc4 hencyyeo/cloud-alarm-server-renewal:v0.0.4-rc4
#docker push hencyyeo/cloud-alarm-server-renewal:v0.0.4-rc4
